# stig-aws-rds-postgres-baseline
...
## Running This Profile
    ...
    inspec exec https://github.com/mitre/stig-aws-rds-postgres-baseline/archive/master.tar.gz -t winrm://<hostip> --user '<admin-account>' --password=<password> --reporter cli json:<filename>.json
...
The following is an example of using this command. 
    ...
    inspec exec https://github.com/mitre/stig-aws-rds-postgres-baseline/archive/master.tar.gz -t winrm://$winhostip --user 'Administrator' --password=Pa55w0rd --reporter cli json:mssql-database-results.json
...
* This project is licensed under the terms of the [Apache 2.0 license](https://github.com/mitre/microsoft-sql-server-2014-database-stig-baseline/blob/master/LICENSE.md).
